...
const posts = [
  {
    ...
    date: "2023-08-01",
    description:
      "A captivating journey through lush forests, majestic mountains, and serene lakes.",
    image: "nature.jpg",
  ...
  },
  {
    ...
    date: "2023-07-15",
    description:
      "Delve into the mysteries of long-lost cultures and their remarkable achievements.",
    image: "ancient.jpg",
  ...
  },
  {
    ...
    date: "2023-06-20",
    description:
      "Embark on a culinary adventure, exploring flavors from around the world and learning expert techniques.",
    image: "culinary.jpg",
  ...
  },
  {
    ...
    date: "2023-05-10",
    description:
      "Peer through telescopes to unravel the mysteries of stars, galaxies, and beyond.",
    image: "cosmos.jpg",
  ...
  },
  {
    ...
    date: "2023-04-02",
    description:
      "Trace the history of innovation, from the first tools to cutting-edge advancements.",
  ...
  },
  {
    ...
    date: "2023-03-15",
    description:
      "Embark on an expedition to untouched landscapes, discovering hidden treasures of nature.",
  ...
  },
  {
    ...
    date: "2023-02-08",
    description:
      "Immerse yourself in the rich tapestry of human creativity, from ancient artworks to modern expressions.",
    image: "art.jpg",
